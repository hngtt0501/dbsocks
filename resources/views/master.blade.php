...
<head>
    <title>Tuhi socks</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta charset="utf-8" />
    <meta name="keywords" content="Tuhi" />
    <script>
...
<body>
    ...
    <header>
        <div class="container">
            ...
            <nav class="top_nav d-flex pt-3 pb-1">
                <!-- logo -->
                <h1>
                    <a class="navbar-brand" href="index.html">th <img src="images/socks (1).png" alt="" width="50px">
                    </a>
                </h1>
                <!-- //logo -->
                <div class="w3ls_right_nav ml-auto d-flex">
                    ...
                    <form class="nav-search form-inline my-0 form-control" action="#" method="post">
                        <select class="form-control input-lg" name="category">
                            ...
                            <optgroup label="Vớ họa tiết">
                                <option value="Hinhhoc">Hình học</option>
                                <option value="Hoathinh">Hoạt hình</option>
                                <option value="Nghethuat">Nghệ thuật</option>
                                <option value="Chu">Chữ</option>
                                <option value="Dongvat">Động vật</option>
                                <option value="Thiennhien">Thiên nhiên</option>
                                <option value="Chambi">Chấm bi</option>
                            </optgroup>
                            <optgroup label="Vớ ">
                                <option value="ngan">Vớ ngắn</option>
                                <option value="dai">Vớ dài</option>
                                <option value="tront">Vớ trơn</option>
                            </optgroup>
                            <optgroup label="Special">
                                <option value="Voembe">Vớ em bé</option>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto text-center">
                        ...
                        <li class="nav-item dropdown has-mega-menu" style="position:static;">
                            <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Vớ họa tiết</a>
                            <div class="dropdown-menu" style="width:30%">
                                <div class="px-0 container">
                                    <div class="row">
                                        <div class="col-md-4" >
                                            <a class="dropdown-item" href="vohoatiet.html">Hình học</a>
                                            <a class="dropdown-item" href="vohoatiet.html">Hoạt hình</a>
                                            <a class="dropdown-item" href="vohoatiet.html">Nghệ thuật</a>
                                         
                                        </div>
                                        <div class="col-md-4">
                                            <a class="dropdown-item" href="vohoatiet.html">Chữ</a>
                                            <a class="dropdown-item" href="vohoatiet.html">Động vật</a>
                                            <a class="dropdown-item" href="vohoatiet.html">Thiên nhiên</a>
                                            <a class="dropdown-item" href="vohoatiet.html">Chấm bi</a>
                        ...
                        <li class="nav-item dropdown has-mega-menu" style="position:static;">
                            <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Vớ</a>
                            <div class="dropdown-menu" style="width:30%">
                                <div class="px-0 container">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <a class="dropdown-item" href="vo.html">Vớ dài</a>
                                            <a class="dropdown-item" href="vo.html">Vớ ngắn</a>
                        ...
                        <li class="nav-item dropdown has-mega-menu" style="position:static;">
                            <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Special</a>
                            <div class="dropdown-menu" style="width:60%">
                                <div class="container">
                                    <div class="row w3_kids  py-3">
                                        <div class="col-md-3 ">
                                            <span class="bg-light">Special</span>
                                            <a class="dropdown-item" href="votreem.html">Vớ trẻ em</a>
                                            <a class="dropdown-item" href="combo.html">Combo</a>
                ...
                <li class="banner">
                    <div class="container">
                        ...
                        <div class="slider-info mt-sm-5">
                            <h4 class="bn_right" style="text-align: center;">
                                <span>c</span>ombo
                                <span>4</span>vớ</h4>
                            <div class="bnr_clip position-relative">
                                ...
                                <p class="text-uppercase py-2">20/01 - 25/01  &nbsp;  </p>
                                <a class="btn btn-primary mt-3 text-capitalize" href="shop.html" role="button">Mua ngay</a>
                            </div>
                        </div>
                    </div>
                </li>
    ...
    <div class="agileits-services" id="services">
        <div class="no-gutters agileits-services-row row">
            <div class="col-lg-3 col-sm-6 agileits-services-grids p-sm-5 p-3">
                ...
                <h4 class="mt-2 mb-3">Đổi trả trong vòng 24h</h4>
            </div>
            <div class="col-lg-3 col-sm-6 agileits-services-grids p-sm-5 p-3">
            ...
            <div class="col-lg-3 col-sm-6 agileits-services-grids p-sm-5 p-3">
                <span class="fas fa-gift p-4"></span>
                <h4 class="mt-2 mb-3">Mua 10 tặng 1</h4>
            </div>
            <div class="col-lg-3 col-sm-6 agileits-services-grids p-sm-5 p-3">
    ...
    <div class="row no-gutters pb-5">
        <div class="col-sm-4">
            <div class="hovereffect">
                <img class="img-fluid" src="images/socks5.jpg" alt="">
                <div class="overlay">
                    <h5>Vớ họa tiết</h5>
                    <a class="info" href="vohoatiet.html">Mua ngay</a>
                </div>
            </div>
        </div>
        <div class="col-sm-4">
            <div class="hovereffect">
                <img class="img-fluid" src="images/socks3.png" alt="">
                <div class="overlay">
                    <h5>Vớ </h5>
                    <a class="info" href="vo.html">Mua ngay</a>
                </div>
            </div>
        </div>
        <div class="col-sm-4">
            <div class="hovereffect">
                <img class="img-fluid" src="images/socks4.jpg" alt="">
                <div class="overlay">
                    <h5>Vớ trẻ em</h5>
                    <a class="info" href="votreem.html">Mua ngay</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <section class="tabs_pro py-md-5 pt-sm-3 pb-5">
        <h5 class="head_agileinfo text-center text-capitalize pb-5">
            <span>s</span>ản <span>p</span>hẩm <span>m</span>ới</h5>
        <div class="tabs tabs-style-line pt-md-5">
            <nav class="container">
                <ul id="clothing-nav" class="nav nav-tabs tabs-style-line" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" href="#women" id="women-tab" role="tab" data-toggle="tab" aria-controls="women" aria-expanded="true">Vớ họa tiết</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#men" role="tab" id="men-tab" data-toggle="tab" aria-controls="men">Vớ
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#girl" role="tab" id="girl-tab" data-toggle="tab" aria-controls="girl">Combo</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#boy" role="tab" id="boy-tab" data-toggle="tab" aria-controls="boy">Vớ trẻ em</a>
                    </li>
                </ul>
            </nav>
            <!-- Content Panel -->
                    ...
                    <div id="owl-demo" class="owl-carousel text-center">
                            ...
                            <div class="card product-men p-3">
                                <div class="men-thumb-item">
                                    ...
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <a href="vosp.html" class="link-product-add-cart">Xem </a>
                                        </div>
                                    </div>
                                </div>
                                <!-- card body -->
                                <div class="card-body  py-3 px-2">
                                    <h5 class="card-title text-capitalize">HT111</h5>
                                    <div class="card-text d-flex justify-content-between">
                                        <p class="text-dark font-weight-bold">25.000</p>
                                        <p class="line-through" style="color: white;">0</p>
                                    </div>
                                </div>
                                <!-- card footer -->
                                <div class="card-footer d-flex justify-content-end">
                                    <form action="#" method="post">
                                        ...
                                        <input type="hidden" name="hub_item" value="HT111">
                                        <input type="hidden" name="amount" value="25.000">
                        ...
                        <div class="item">
                            ...
                            <div class="card product-men p-3">
                                ...
                                <!-- card body -->
                                <div class="card-body  py-3 px-2">
                                    <h5 class="card-title text-capitalize">HT112</h5>
                                    <div class="card-text d-flex justify-content-between">
                                        <p class="text-dark font-weight-bold">25.000</p>
                                        <p class="line-through" style="color: white;">0</p>
                                    </div>
                                ...
                                <div class="card-footer d-flex justify-content-end">
                                    <form action="#" method="post">
                                        <input type="hidden" name="cmd" value="_cart">
                                        <input type="hidden" name="add" value="1">
                                        <input type="hidden" name="hub_item" value="HT112">
                                        <input type="hidden" name="amount" value="25.000">
                                        <button type="submit" class="hub-cart phub-cart btn">
                                            <i class="fa fa-cart-plus" aria-hidden="true"></i>
                                        </button>
                        ...
                        <div class="item">
                            ...
                            <div class="card product-men p-3">
                                ...
                                <!-- card body -->
                                <div class="card-body  py-3 px-2">
                                    <h5 class="card-title text-capitalize">HT113</h5>
                                    <div class="card-text d-flex justify-content-between">
                                        <p class="text-dark font-weight-bold">25.000</p>
                                            <p class="line-through" style="color: white;">0</p>
                                    </div>
                                ...
                                <div class="card-footer d-flex justify-content-end">
                                    <form action="#" method="post">
                                        <input type="hidden" name="cmd" value="_cart">
                                        <input type="hidden" name="add" value="1">
                                        <input type="hidden" name="hub_item" value="HT113">
                                        <input type="hidden" name="amount" value="25.000">
                                        <button type="submit" class="hub-cart phub-cart btn">
                                            <i class="fa fa-cart-plus" aria-hidden="true"></i>
                                        </button>
                        ...
                        <div class="item">
                            ...
                            <div class="card product-men p-3">
                                ...
                                <!-- card body -->
                                <div class="card-body  py-3 px-2">
                                    <h5 class="card-title text-capitalize">HT114</h5>
                                    <div class="card-text d-flex justify-content-between">
                                        <p class="text-dark font-weight-bold">25.000</p>
                                        <p class="line-through" style="color: white;">0</p>
                                    </div>
                                ...
                                <div class="card-footer d-flex justify-content-end">
                                    <form action="#" method="post">
                                        <input type="hidden" name="cmd" value="_cart">
                                        <input type="hidden" name="add" value="1">
                                        <input type="hidden" name="hub_item" value="HT114">
                                        <input type="hidden" name="amount" value="25.000">
                                        <button type="submit" class="hub-cart phub-cart btn">
                                            <i class="fa fa-cart-plus" aria-hidden="true"></i>
                                        </button>
        ...
        <div class="footerv2-w3ls">
            ...
            <!-- <div class="container-fluid py-5 footer-copy_w3ls">
                <<div class="d-lg-flex justify-content-between"> -->
                    ...
                    <!-- <div class="cpy-right align-self-center" style="text-align: right;">
                        <h2 class="agile_btxt" >
                            <a href="index.html">
                                <span>t</span>u
                                <span>h</span>i Socks</a>
                        </h2>
